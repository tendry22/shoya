...
const Skrill = () => {
  ...
  const [nbrSkrill, setNbrSkrill] = useState(0);
  ...
  useEffect(() => {
    const fetchRef = async () => {
      ...
      if (jwt_token) {
        ...
        const skrill = await Axios.post(`${BASE_URL}/skrill/findTodayByUser`, { iduser: user.data.id });
        setNbrSkrill(skrill.data.length);
      } else {
    ...
    const fetchCours = async () => {
      try {
        ...
        for (let i = 0; i < liste.length; i++) {
          if (response.data[i].actif == "skrill") {
    ...
    >
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.formCard}>
          <Text style={styles.texte}>Retrait Skrill</Text>
          <View style={styles.container}>
            <View style={styles.inputContainer}>
              ...
              <View style={styles.copyContainer}>
                <Text style={styles.txtMailTxt}>{userRef}</Text>
              ...
              <TouchableOpacity style={styles.button} onPress={handleSubmit}>
                <Text style={styles.buttonText}>Skrill Envoyé</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
